...
@Component({
  selector: 'menu-choise-exp-on-planing',
  templateUrl: './menu-choise-exp-on-planing.component.html',
  styleUrls: ['./menu-choise-exp-on-planing.component.scss']
})
export class MenuChoiseExpOnPlaningComponent implements OnInit {
  ...
  onSelect(variable: MenuChoiser): void {
    ...
    let variantPoint = document.querySelectorAll('.b-selector__variable_expOnPlan')
