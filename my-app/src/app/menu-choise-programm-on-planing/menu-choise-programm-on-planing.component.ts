...
@Component({
  selector: 'menu-choise-programm-on-planing',
  templateUrl: './menu-choise-programm-on-planing.component.html',
  styleUrls: ['./menu-choise-programm-on-planing.component.scss']
})
export class MenuChoiseProgrammOnPlaningComponent implements OnInit {
  ...
  onSelect(variable: MenuChoiser): void {
    ...
    let variantPoint = document.querySelectorAll('.b-selector__variable_programmOnPlan')
